...
function storeVariable() {
    ...
    startDate = sessionStorage.setItem("START", document.getElementById("startDate").value.toString().replace('-',''));
    startDate.replace("-","");
    endDate = sessionStorage.setItem("END", document.getElementById("endDate").value.toString().replace('-', ''));
  ...
  function getSearch() {
    var searchJSON = JSON.stringify({'url': document.getElementById("url"), 'startDate': document.getElementById("startDate").value, 'endDate': document.getElementById("endDate").value, 'keyword': document.getElementById("keyword").value, 'depth': document.getElementById("depth").value});
    return searchJSON;
  }
